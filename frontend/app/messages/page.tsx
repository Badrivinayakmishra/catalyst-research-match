...
export default function MessagesPage() {
  ...
  const conversations = [
    {
      id: 1,
      piName: "Dr. Jennifer Smith",
      piInitials: "JS",
      labName: "Computational Neuroscience Lab",
      lastMessage: "Great! I'd love to schedule an interview. Are you available next Tuesday?",
    ...
    },
    {
      ...
      lastMessage: "Do you have experience with quantum algorithms?",
    ...
    {
      id: 4,
      piName: "Dr. David Park",
      piInitials: "DP",
      labName: "Machine Learning Research Lab",
      lastMessage: "Looking forward to meeting you at the interview!",
  ...
  const messages = [
    ...
    },
    {
      ...
      sender: "pi",
      senderName: "Dr. Jennifer Smith",
      text: "That's excellent! Your experience aligns well with what we're looking for. I'd like to discuss the position further with you.",
    ...
    },
    {
      ...
      sender: "pi",
      senderName: "Dr. Jennifer Smith",
      text: "Great! I'd love to schedule an interview. Are you available next Tuesday at 2 PM?",
      timestamp: "2 hours ago"
    }
  ]
  ...
  const filteredConversations = conversations.filter(conv =>
    conv.piName.toLowerCase().includes(searchQuery.toLowerCase()) ||
    conv.labName.toLowerCase().includes(searchQuery.toLowerCase())
  )
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4" style={{ backgroundColor: '#F9F7F2' }}>
                {messages.map((message) => (
                  ...
                  >
                    <div className={`max-w-lg ${message.sender === 'student' ? 'order-2' : 'order-1'}`}>
                      <div
                        className="rounded-2xl px-4 py-3 shadow-sm"
                        style={{
                          backgroundColor: message.sender === 'student' ? '#2563EB' : '#FFFFFF',
                          color: message.sender === 'student' ? '#FFFFFF' : '#0B2341',
                          borderRadius: message.sender === 'student' ? '20px 20px 4px 20px' : '20px 20px 20px 4px'
                        }}
                      >
